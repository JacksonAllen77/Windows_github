...
uint16_t CountSensor_Count;//定义一个变量记录中断触发次数
void CountSensor_Init(void)
{
	...
	NVIC_InitStructure.NVIC_IRQChannel=EXTI15_10_IRQn;//指定中断通道[PB14所以选这个]
...
{
	return CountSensor_Count;//获取计数次数
}
void EXTI15_10_IRQHandler(void)//编写中断函数【无参无返回值】
{
